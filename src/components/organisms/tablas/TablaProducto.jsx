...
import { columnas, Paginacion, useProductosStore, v} from "../../../index";

export const TablaProducto = ({data, setAccion, setDataSelect, setOpenRegistro }) => {
    const [pagina, setPagina] = useState(1);
    const { eliminarProducto } = useProductosStore();

    // useEffect(() => {
    //     // Evita recargas infinitas
    //     if (!window.location.hash.includes('#recargado')) {
    //         window.location.href = window.location.href + '#recargado';
    ...
    const columns = useMemo(() => columnas(editar, eliminar), []);
