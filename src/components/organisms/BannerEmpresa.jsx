...
export function BannerEmpresa() {
    ...
    const { dataEmpresa, nroUsuarios } = useEmpresaStore();
    ...
    return (
        <Container>
            <div className="content-wrapper-context">
                ...
                <ContentSocial>
                    <CardDatosEmpresa titulo="Moneda" valor={dataEmpresa?.simbolo_moneda}/>
                    <CardDatosEmpresa titulo="Usuarios" valor={nroUsuarios}/>
                </ContentSocial>
            </div>
            ...
            >
                <path opacity="0.40"
                      ...
                      stroke="url(#paint0_radial_932_3040)" strokeWidth="0.5"/>
                <defs>
                    <radialGradient id="paint0_radial_932_3040" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
...
const Container = styled.div`
    ...
    &:hover {
        .cuadros {
            ...
            rotateY(12deg) rotate(3deg) skew(2deg)
