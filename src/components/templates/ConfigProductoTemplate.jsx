...
import { DataSubModuloProductos } from "../../utils/dataEstatica";
import { Mensaje } from "../../index.js";

export function ConfigProductoTemplate() {

    return (
        <Container>
            <div id="cards">
                {DataSubModuloProductos.map((item, index) => {
                    return (
...
const Container = styled.div`
    ...
    /* background-image: url(${new URL("../../assets/fondocuadros.svg", import.meta.url).href}); */
